...
//  return `Поздравь с днём рождения нашего коллегу ${name}, занимающего должность ${position}`;
//}
//
// getAccessToken().then((tokenData) => {
//  const accessToken = tokenData.access_token;
//  getListOfModels(accessToken).then((models) => {
//    const message = `Поздравь с днём рождения нашего коллегу ФИО, занимающего должность ДОЛЖНОСТЬ.`;

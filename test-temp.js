...
const auth = new google.auth.GoogleAuth({
  keyFile: config.googleSheetsApiKeyFile,
...
const rootCA = fs.readFileSync(config.rootCA);
const subCA = fs.readFileSync(config.subCA);
...
// Функц��я для генерации поздравления через GigaChat
